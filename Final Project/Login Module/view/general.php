...
require_once '../controller/get_users_count.php';
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="background: linear-gradient(to right, #0052d4, #4364f7, #6fb1fc);">
  ...
  <br>
  <div class="container">
    <h4 style="text-align:center; color:#5c258d;">LETS FIND HOME AS OF TODAY</h4>
  <div class="row">
    <div class="col">
      <p style="text-align: center; font-size:60px; color:#4b6cb7; font-family: 'Outfit', sans-serif;"><?php echo $num; ?></p>
      <p style="text-align: center; font-size:30px">Users</p>
    </div>
    <div class="col">
    <p style="text-align: center;font-size:60px; font-family: 'Outfit', sans-serif; color: #780206;"><?php echo $ad_num; ?></p>
    <p style="text-align: center; font-size:30px">Ad(s)</p>
    </div>
  </div>
</div><br>
