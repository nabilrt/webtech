            ...
            <tr>
                ...
                <td style="width:550px; vertical-align:top; padding: 10px 15px;">
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                        <label>Name</label><br>
                        <input type="text" name="name" id="name" placeholder="Full Name" value="<?php echo $Full_Name; ?>"><span style="color: red;">
                        <?php
                        if ($nameError != "") {
                        echo "* - " . $nameError;
                        }
                        ...
                        <input type="password" name="pass" id="pass" placeholder="Password" value="<?php echo $Password; ?>"><span style="color: red;">
                        <?php
                        if ($passError != "") {
                        echo "* - " . $passError;
                        }
                        ...
                        <input type="password" name="c_pass" id="c_pass" placeholder="Confirm Password" value="<?php echo $Password; ?>"><span style="color: red;">
                        <?php
                        if ($cpassError != "") {
                        echo "* - " . $cpassError;
                        }
                        ...
                        <input type="text" name="email" id="email" placeholder="Email" value="<?php echo $Email; ?>"><span style="color: red;">
                        <?php
                        if ($emailError != "") {
                        echo "* - " . $emailError;
                        }
                        ...
                        <input type="radio" id="gender" name="gender" value="Prefer not to Say" <?php if ($Gender == "Prefer not to Say") { echo "checked"; } ?>>Prefer not to say&nbsp;<span style="color: red;">
                        <?php
                        if ($genderError != "") {
                        echo "* - " . $genderError;
                        }                                                                                                                                                            ?></span><br><br>
