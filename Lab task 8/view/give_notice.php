...
<body class="bd">
  ...
  <div style="display:flex">
        ...
        <div class="form-group">
           ...
           <input type="text" name="notice_id" id="notice_id" onkeyup="return notice_id_validate()" onblur="return notice_id_validate()" value="" class="form-control"><span id="noticeIDErr" style="color:red">
           <?php
