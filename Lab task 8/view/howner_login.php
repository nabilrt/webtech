...
<div class="center">
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" onsubmit="return login_validation()">
        <div class="text-field">
            ...
            <input type="text" name="nid" id="login_nid" onkeyup="return nid_validate()" onblur="return nid_validate()" value="<?php if (isset($_COOKIE['nid'])) { echo $_COOKIE['nid']; } ?>"><br>
        </div>
        <div class="text-field">
            ...
            <input type="password" name="pass" id="login_pass" onkeyup="return pass_validate()" onblur="return pass_validate()" value="<?php if (isset($_COOKIE['password'])) { echo $_COOKIE['password']; } ?>"><br>
            <script>
                function myFunction() {
