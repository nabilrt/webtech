    ...
    <div style="display:flex;">
        ...
        <?php include 'menu.php'; ?> 
                ...
                <h3 style="padding-left:50px"><b>Post Ads</b></h3><br>
                    <form method="POST" name="m_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" onsubmit="return ad_post_validation()">
                    <div class="form-group" style="padding-left:50px">
                        <label>AD_ID</label><br>
                        <input type="text" name="ad_id" id="ad_id" value="" onkeyup="return aid_validate()" onblur="return aid_validate()" class="form-control"><br><span id="idError" style="color:red"></span><br>
                        ...
                        <br><span id="rentError" style="color:red">
                            <?php
                            if ($rentError != "") {
                                echo $rentError;
                            }
                        ...
                        <input type="text" name="ad_address" id="ad_address" onkeyup="return address_validate()" onblur="return address_validate()" value="" class="form-control"><br>
                        ...
                        <input type="textarea" name="msg" id="desc" onkeyup="return desc_validate()" onblur="return desc_validate()" rows="3" class="form-control" data-toggle="tooltip" data-placement="top" title="Enter the correct description of your house"><br>
                        <span id="descError" style="color:red"></span><br>
                        <label>Picture 1</label><br>
                        <input type="file" name="fileToUpload" id="f1" class="form-control" data-toggle="tooltip" data-placement="top" title="Select a Picture of your Interior"><br><span id="f1Error" style="color:red">
                        </span><br>
                        <label>Picture 2</label><br>
                        <input type="file" name="fileToUpload1" id="f2" class="form-control" data-toggle="tooltip" data-placement="top" title="Select a Picture of your Interior"><br><span id="f2Error" style="color:red">
                        </span><br>
                        <label>Picture 3</label><br>
                        <input type="file" name="fileToUpload2" id="f3" class="form-control" data-toggle="tooltip" data-placement="top" title="Select a Picture of your Interior"><br><span id="f3Error" style="color:red">
                        </span><br>
