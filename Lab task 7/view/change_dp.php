...
<body class="bd">
    ...
    <div style="display: inline-block; padding-left: 45px">
                    <fieldset class="fieldsetAdjust">
                        <h3 style="color: black; font-family: 'Roboto', sans-serif;">Update Profile Picture</h3><br>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                            <img src="<?php echo $Image ?>" alt="" width="150px" height="150px" class="rounded float-start"><br><br><br><br><br><br>&nbsp;
                            <p></p>
                            <input type="file" name="fileToUpload" id="fileToUpload" style="color: black;" class="form-control"><br><span style="color:red">
                                <?php
                                if ($imageError != "") {
                                    echo $imageError;
                                }
