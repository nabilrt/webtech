  ...
  <div style="display:flex">
   ...
   <?php include 'menu.php'; ?>
        ...
        <div class="form-group" style="padding-left: 50px;">
            ...
            <input type="text" name="ad_rent" class="form-control"  value="<?php echo $ad_rent; ?>"><br> <span style="color:red">
            <?php
            if($rentError!=""){
                echo $rentError;
            }
            ...
            <label>Area</label><br>
            <input type="text" name="ad_area" class="form-control" value="<?php  echo $ad_area; ?>">
            ...
            <input type="text" name="ad_address" id="ad_address" class="form-control" value="<?php echo $ad_address; ?>"><br><span style="color:red">
            <?php
            if($addressError!=""){
                echo $addressError;
            }
            ...
            <input type="text" name="msg" class="form-control" value="<?php echo $ad_des; ?>"><br>
            <label>Picture 1</label><br>
            <input type="file" name="fileToUpload" class="form-control" value="<?php echo $p1;?>"><span>            
            </span><br>
            <label>Picture 2</label><br>
            <input type="file" name="fileToUpload1" class="form-control" value="<?php echo $p2; ?>"><span>
            </span><br>
            <label>Picture 3</label><br>
            <input type="file" name="fileToUpload2" class="form-control" value="<?php echo $p3; ?>"><span>            
            </span><br>
