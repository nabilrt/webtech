    ...
    <div style="display:flex">
                ...
                <div class="form-group">
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                        <label>Name</label><br>
                        <input type="text" name="name" id="name" placeholder="Full Name" class="form-control" value="<?php echo $Full_Name; ?>"><br><span style="color: red;">
                        <?php
                        if ($nameError != "") {
                        echo "* - " . $nameError;
                        }
                        ...
                        <input type="password" name="pass" id="pass" placeholder="Password" class="form-control" value="<?php echo $Password; ?>"><span style="color: red;">
                        <?php
                        if ($passError != "") {
                        echo "* - " . $passError;
                        }
                        ...
                        <input type="password" name="c_pass" id="c_pass" class="form-control" placeholder="Confirm Password" value="<?php echo $Password; ?>"><span style="color: red;">
                        <?php
                        if ($cpassError != "") {
                        echo "* - " . $cpassError;
                        }
                        ...
                        <input type="text" name="email" id="email" placeholder="Email" class="form-control" value="<?php echo $Email; ?>"><span style="color: red;">
                        <?php
                        if ($emailError != "") {
                        echo "* - " . $emailError;
                        }
                        ?></span><br>
                        <label>Gender</label>&nbsp;
                        <input type="radio" id="gender" class="form-check-input" name="gender" value="Male" <?php if ($Gender == "Male") { echo "checked"; } ?>><label class="form-check-label" for="flexRadioDefault2">&nbsp;Male</label>&nbsp;
                        <input type="radio" id="gender" class="form-check-input" name="gender" value="Female" <?php if ($Gender == "Female") { echo "checked"; } ?>> <label class="form-check-label" for="flexRadioDefault2"> Female</label>&nbsp;
                        <input type="radio" id="gender" class="form-check-input" name="gender" value="Prefer not to Say" <?php if ($Gender == "Prefer not to Say") { echo "checked"; } ?>><label class="form-check-label" for="flexRadioDefault2">&nbsp; Prefer not to say</label>&nbsp;<br><span style="color: red;">
                        <?php
                        if ($genderError != "") {
                        echo "* - " . $genderError;
                        }
